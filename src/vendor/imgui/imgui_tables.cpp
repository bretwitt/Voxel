...
void ImGui::TableUpdateBorders(ImGuiTable* table)
{
    ...
    // Actual columns highlight/gfx will be performed in EndTable() and not be affected.
...
// Bg2 is used by Selectable (and possibly other widgets) to gfx to the background.
...
// FIXME-TABLE: This is a mess, need to redesign how we gfx borders (as some are also done in TableEndRow)
