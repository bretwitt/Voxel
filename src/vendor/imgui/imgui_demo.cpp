...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct Dear ImGui to gfx a mouse cursor itself. Note that a mouse cursor rendered via your application GPU rendering path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop applications may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");
...
static void ShowDemoWindowMisc()
{
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        if (ImGui::TreeNode("Mouse cursors"))
        {
            ...
            ImGui::SameLine(); HelpMarker(
                "Your application can gfx a different mouse cursor based on what ImGui::GetMouseCursor() returns. "
...
static void NodeFont(ImFont* font)
{
    ...
    ImGui::SameLine(); HelpMarker(
        ...
        "You can also gfx at multiple sizes and select which one to use at runtime.\n\n"
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Rendering"))
        {
            ...
            ImGui::SameLine();
            HelpMarker("Faster lines using texture data. Require backend to gfx with bilinear filtering (not point/nearest filtering).");
